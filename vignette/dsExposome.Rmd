...
ds.plotFamily("exposome_object", family = "Phthalates", group = "sex", group2 = "rhinitis")
```
...
```{r}
corr_data <- ds.correlation("exposome_object", c("Air Pollutants", "Noise"))
corPlot(corr_data)
```
