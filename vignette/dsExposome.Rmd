...
To check on the general details of the loaded dataset, the name of the exposures and phenotypes present can be retrieved with the `ds.exposome_variables`. This function has the option of retrieving them separately or all together, check the function documentation for the details.
...
### Summary of a variable of interest
