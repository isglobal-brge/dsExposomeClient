...
Rscript -e "install.packages(c('git2r', 'covr', 'withr', 'devtools', 'lintr', 'mockery', 'pkgdown', 'corrplot', 'circlize', 'FactoMineR', 'sf'), repos='https://cloud.r-project.org', lib='${R_LIBS_USER}')"
